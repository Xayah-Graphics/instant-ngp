    ...
    try {
        ...
        while (last_train.step < target_training_step) {
            ...
            if (should_log) {
                ...
                std::println("step={} loss={} steps_per_second={} train_ms={} prep_ms={} elapsed_s={}", last_train.step, last_train.loss, steps_per_second, last_train.train_ms, last_train.prep_ms, elapsed_seconds);
                interval_start         = now;
            ...
            if (should_validate) {
                ...
                std::println("validation step={} images={} total_pixels={} mean_mse={} mean_psnr={} split_psnr={} min_psnr={} max_psnr={} benchmark_ms={} images_per_second={} report={}", last_train.step, validation.image_count, validation.total_pixels, validation.mean_mse, validation.mean_psnr, validation.split_psnr, validation.min_psnr, validation.max_psnr, validation.benchmark_ms, images_per_second, report_path.string());
            }
        }
        ...
        if (should_test_at_end) {
            ...
            std::println("test step={} images={} total_pixels={} mean_mse={} mean_psnr={} split_psnr={} min_psnr={} max_psnr={} benchmark_ms={} images_per_second={} report={}", last_train.step, test.image_count, test.total_pixels, test.mean_mse, test.mean_psnr, test.split_psnr, test.min_psnr, test.max_psnr, test.benchmark_ms, images_per_second, options.test_report.string());
        }
